...
class IRC:
    ...
    # 3. Message Sending
    async def send(self, *msg: str, force: bool = False, tags: TagsDict | None = None) -> None: ...
    async def command(self, command: str, *args: str, force: bool = False, tags: TagsDict | None = None) -> None: ...
    ...
    async def ctcp(self, target: str, *msg: str, reply: bool = False, tags: TagsDict | None = None) -> None: ...
